...
class Quiz(UserMixin,db.Model):
    ...
    created_by_mentor  = db.relationship('Mentor', foreign_keys=[created_by_mentor_id], backref='quizzes_created')
...
class Answer(db.Model):
    ...
    # Constraints
    __table_args__ = (
        db.UniqueConstraint('user_id', 'quiz_id', 'question_id', name='unique_user_quiz_question'),
    )
